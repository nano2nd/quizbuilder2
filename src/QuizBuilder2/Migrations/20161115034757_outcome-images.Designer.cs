...
namespace QuizBuilder2.Migrations
{
    ...
    [Migration("20161115034757_outcome-images")]
    partial class outcomeimages
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("QuizBuilder2.Data.Entities.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("QuizBuilder2.Data.Entities.Answer", b =>
                {
                    b.HasOne("QuizBuilder2.Data.Entities.Photo", "Photo")
                        .WithMany()
